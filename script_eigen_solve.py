...
eigen.form_equations(
    ...
    save_to=os.path.join(output_dir, "S_L2_N1/eqs_cg_ideal_vsH.json"),
    overwrite=False,
    verbose=5
)
...
eigen.collect_matrix_elements(
    read_from=os.path.join(output_dir, "S_L2_N1/eqs_cg_ideal_vsH.json"),
    manual_select=xpd_cfg.field_indexer,
    expansion_recipe=xpd_cfg.recipe,
    save_to=os.path.join(output_dir, "S_L2_N1/Canonical/matrix_expr_ideal_vsH.json"),
    overwrite=False,
    verbose=5
)
...
#         "S_L2_N1/Canonical/matrix_expr_ideal.json"
