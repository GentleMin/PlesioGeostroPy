...
class TestSimplifiedEquations:
    
    @pytest.fixture(autouse=True)
    def load_equations(self):
        eq_base_path = "./out/symbolic/Malkus/eqs_ptb.json"
        eq_comp_path = "./out/symbolic/Malkus/eqs_ptb_deduce.json"

        with open(eq_base_path, 'r') as fread:
            self.eq_base = base.CollectionPG.load_json(fread, parser=parse_expr)
        with open(eq_comp_path, 'r') as fread:
            self.eq_comp = base.CollectionPG.load_json(fread, parser=parse_expr)
